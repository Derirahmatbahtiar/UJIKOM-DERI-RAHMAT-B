...
<div style="display:flex;">
    ...
    <div style="display:flex;">
        ...
        <div class="card-body" style="background-color:red; border-radius:10px;">
            ...
            <a href="/pelanggan" style="color:white; text-decoration:none;">More
    ...
    <div class="card" style="width: 18rem; border-radius:10px;">
        <div class="card-body" style="background-color:green; border-radius:10px;">
            <h5 class="card-title" style="color:white;">Data produk</h5>
            <p style="display:flex;" class="card-text">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
            <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5l2.404.961L10.404 2zm3.564 1.426L5.596 5 8 5.961 14.154 3.5zm3.25 1.7-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923zM7.443.184a1.5 1.5 0 0 1 1.114 0l7.129 2.852A.5.5 0 0 1 16 3.5v8.662a1 1 0 0 1-.629.928l-7.185 2.874a.5.5 0 0 1-.372 0L.63 13.09a1 1 0 0 1-.63-.928V3.5a.5.5 0 0 1 .314-.464z"/>
            </svg>
            </p>
            <a href="/data-barang" style="color:white; text-decoration:none;">More
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-square-fill" viewBox="0 0 16 16">
            <path d="M0 14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2zm4.5-6.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5a.5.5 0 0 1 0-1"/>
            </svg>
            <h3>{{$total_produk}}</h3>
    ...
    <div class="card" style="width: 18rem; margin-left:2%; border-radius:10px;">
        <div class="card-body" style="background-color:blue; border-radius:10px;">
            ...
            <a href="data-penjualan" style="color:white; text-decoration:none;">More
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-square-fill" viewBox="0 0 16 16">
        <path d="M0 14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2zm4.5-6.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5a.5.5 0 0 1 0-1"/>
        </svg>
...
<div style="width:50%;">
<h3 style="text-align:center;">Data penjualan bulanan</h3>
<div>
