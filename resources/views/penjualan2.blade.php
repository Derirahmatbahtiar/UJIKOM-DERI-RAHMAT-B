...
<div style="display:flex;">
    ...
    <li>
        ...
        <thead style="border:3px solid;">
                ...
                $total_harga = 0?>
                    @foreach($detail_penjualan as $detail_penjualan)
                            <tr>
                                ...
                                <th>{{number_format($detail_penjualan->harga,0,',','.')}}</th>
                                <th>{{$detail_penjualan->jumlah_produk}}</th>
                                <th>{{number_format($detail_penjualan->SubTotal,0,',','.')}}</th>
                                <?php  $total_harga = $total_harga + $detail_penjualan->SubTotal ?>
                                <th>  <a href="hapus-pen/{{$detail_penjualan->detail_id}}" class="btn btn-outline-danger">
                ...
                <div class="container" style="background-color:black; width:20%; padding:1%; margin-right:100%; ">
            <h5 style="color:white;"> Total Harga : {{number_format($total_harga,0,',','.')}}</h5>
        </div>
    ...
    <div>
            <br>
            <label><b>Masukan nama pelanggan</b></label>
